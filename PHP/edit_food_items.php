...
<div class="container">
    <div class="container">
        ...
        <a href="view_order_details.php" class="list-group-item ">View Order Details</a>
          <a href="view_order_expired.php" class="list-group-item ">View Order Expired</a>
    	</div>
    </div>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($con, "UPDATE food set
    name='$name', price='$price',
    description='$description' where F_ID='$F_ID'");
    }
    $query = mysqli_query($con, "SELECT * FROM food f WHERE f.R_ID IN (SELECT r.R_ID FROM RESTAURANTS r WHERE r.M_ID='$user_check') ORDER BY F_ID");
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($con, "SELECT * FROM food WHERE F_ID=$update");
