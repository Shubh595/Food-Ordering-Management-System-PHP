...
if (isset($_SESSION['login_user2'])) {    
    header("location: shop_list.php?blockid='$_GET[blockid]'"); //Redirecting to myrestaurant Page
}
?>
...
<html>
    ...
    <head>
        <title> Guest Login | Yummy.com </title>
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1>Hi Guest,<br> Welcome to <span class="edit"> Yummy.com </span></h1>
            <br>
