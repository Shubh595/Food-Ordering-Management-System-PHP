...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse " id="myNavbar">
                    ...
                    if (isset($_SESSION['login_user1'])) {
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active" ><a href="home.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart
                                    (<?php
        ...
        if (!empty($_SESSION["cart"])) {
            ...
            <div class="table-responsive" style="padding-left: 100px; padding-right: 100px;" >
                ...
                <?php
                echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Empty Cart</button></a>&nbsp;<a href="home.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Check Out</button></a>';
                ?>
            </div>
        ...
        if (empty($_SESSION["cart"])) {
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Your Shopping Cart</h1>
                    <p>Oops! We can't smell any food here. Go back and <a href="home.php">order now.</a></p>
    ...
    <?php
    //logic copyed from https://givemeans.wordpress.com/search/name/page/5196/?php_echo_base_url(%27assets/js/bootstrap_min_js%27);_
    
        if (isset($_POST["add"])) {
            if (isset($_SESSION["cart"])) {
               $item_array_id = array_column($_SESSION["cart"], "food_id"); //>php5.5                
               // $item_array_id = array_map($_SESSION["cart"], "food_id");//this code run on php5.0
