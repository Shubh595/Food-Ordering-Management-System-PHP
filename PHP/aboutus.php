...
?>
    ...
    <div class="paragraph1">
      <h1>OUR TEAM</h1>
      <h3><p>Yummy.com was founded in 2019. We care about quality, craft and disciplined experimentation. We are active contributors to open source software.</p><p> We help innovate, develop and pioneer. </p></h3>
    </div>
    ...
    <div class="col-md-10" style="float: none; margin: 0 auto;">
        <div class="paragraph2">
          ...
          <div class="goldcolor">
            ...
            <h3>You hired Yummy.com, and now we're one team with a shared mission. Let's figure it our together.</h3>
          </p>
          <p><br>
          <div class="goldcolor">
    ...
    <h3>
      <p>
        The purpose of <font color="green"><strong>Yummy.com</strong></font> is to automate the existing manual system by the help of computerized equipments and full-fledged computer software, fulfilling their requirements, so that their valuable data/information can be stored for a longer period with easy accessing and manipulation of the same. The required software and hardware are easily available and easy to work with.
      </p>
      <p>
        <font color="green"><strong>Yummy.com</strong></font>, as described above, can lead to <font color="green"><strong>error free, secure, reliable and fast management system.</strong></font> It can assist the user to concentrate on their other activities rather to concentrate on the record keeping. Thus it will help organization in better utilization of resources. The organization can maintain computerized records without redundant entries. That means that one need not be distracted by information that is not relevant, while being able to reach the information. 
      </p>
      <p>
