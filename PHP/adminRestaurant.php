        ...
        <div class="container">
            ...
            <div class="col-xs-3" style="text-align: center;">
                ...
                <div class="list-group">
                    <a href="adminHome.php" class="list-group-item  ">View Users</a>
                    <a href="adminRestaurant.php" class="list-group-item active">View Restaurant</a> 
            ...
            <div class="col-xs-9">
                <div class="form-area" style="padding: 0px 100px 100px 100px;">
                    <form action="" method="POST">
                        <br style="clear: both">
                        <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Restaurant LIST </h3>
