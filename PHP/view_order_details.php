            ...
            <div class="col-xs-9">
                <div class="form-area" style="padding: 0px 0px 0px 0px;">
                    <form action="" method="POST">
                        ...
                        <h5 style="margin-bottom: 0px; text-align: center; font-size: 20px;"> YOUR FOOD ORDER LIST </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                if ($row["status"] == "Booked") {
                                                    ?>
                                                    <a href="delivedFood.php?id=<?php echo $row["order_ID"]; ?>">Make Deliver</a>
                                                    <?php
                                                } else {
                                                    echo $row["status"];
                                                }
